...
def run_cycle(state_episode):
    ...
    for e in range(Parameters.N_epochs_per_episode):
        ...
        tf.print("----------------------------------")
        tf.print("Normalized MSE epoch loss: " + str(epoch_loss / (Parameters.N_episode_length * Parameters.N_sim_batch)))
        tf.print("Normalized epoch loss: " + str(tf.math.sqrt(epoch_loss / (Parameters.N_episode_length * Parameters.N_sim_batch))))
        tf.print("----------------------------------")
        tf.print("Normalized MSE epoch loss without penalties: " + str(net_epoch_loss / (Parameters.N_episode_length * Parameters.N_sim_batch)))
        tf.print("Normalized epoch loss without penalties: " + str(tf.math.sqrt(net_epoch_loss / (Parameters.N_episode_length * Parameters.N_sim_batch))))
        tf.print("==================================")
