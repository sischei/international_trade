...
def equations(state, policy_state):
    ...
    loss_dict['eq_1'] = 1000*E_t(lambda s, ps: Cy_norm * Definitions.Cy_norm(s, ps) * lambday_norm - Definitions.Cy_norm(s, ps) * State.nux(state) + Cy_norm * beta * b_habit * State.nux (s)) 
